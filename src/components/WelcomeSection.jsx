    ...
    <Box sx={{ mb: 2 }}>
      ...
      <Accordion>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography sx={{ fontWeight: 600 }} variant="body2" >How to Use This Tool</Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      <Accordion>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography sx={{ fontWeight: 600 }} variant="body2" >Understanding Percentiles</Typography>
        </AccordionSummary>
        <AccordionDetails>
